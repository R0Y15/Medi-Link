  ...
  return (
    <div className="flex flex-col gap-5 py-4">
      ...
      <div className="flex flex-col gap-2 px-2">
        ...
        <h1 className="text-heading2-semibold text-foreground">Pharmacy Management</h1>
        <p className="text-muted-foreground">Monitor medicine inventory, track stock levels, and manage supplies</p>
      </div>
