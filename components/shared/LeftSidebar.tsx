...
const LeftSidebar = () => {
  ...
  return (
    <section className='custom-scrollbar leftsidebar pr-5'>
      <div className='flex flex-1 flex-col bg-white rounded-2xl py-5 shadow-lg'>
        <div className="flex w-full flex-1 flex-col gap-4 px-6 rounded-2xl">
          <h1 className='font-semibold hidden lg:block lg:text-[20px] my-3 px-4'>Menu</h1>
        ...
        <div className="mt-10 px-6">
          ...
          <div className="flex cursor-pointer gap-4 p-4 rounded-lg">
            <Image
            ...
            <p className="max-lg:hidden text-[#E72838]">Logout</p>
          </div>
          {/* </SignOutButton> */}
          {/* </SignedIn> */}
        </div>
